...
`SyntaxBNF.g4` is an ANTLR4 metagrammar for the four kinds of definition in
...
```bash
java -jar ../ANTLRParsers/antlr-4.13.2-complete.jar SyntaxBNF.g4
javac -cp ../ANTLRParsers/antlr-4.13.2-complete.jar SyntaxBNF*.java
java -cp "../ANTLRParsers/antlr-4.13.2-complete.jar:." \
  org.antlr.v4.gui.TestRig SyntaxBNF document -tree ../SyntaxBNF-v9.2.1.4
```
